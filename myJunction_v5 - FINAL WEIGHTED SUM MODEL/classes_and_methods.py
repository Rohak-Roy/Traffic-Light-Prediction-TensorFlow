...
def getData(edgeInfo1, edgeInfo2, edgeInfo3, edgeInfo4):
    ...
    return [numOfVehiclesStopped_horizontal, totalWaitingTime_horizontal, totalCO2Emission_horizontal, numOfCars_horizontal, numOfBuses_horizontal, numOfTrucks_horizontal, numOfMotorcycles_horizontal, numOfBicycles_horizontal, numOfPredictedVehiclesAtTLS_horizontal,
            numOfVehiclesStopped_vertical, totalWaitingTime_vertical, totalCO2Emission_vertical, numOfCars_vertical, numOfBuses_vertical, numOfTrucks_vertical, numOfMotorcycles_vertical, numOfBicycles_vertical, numOfPredictedVehiclesAtTLS_vertical]
