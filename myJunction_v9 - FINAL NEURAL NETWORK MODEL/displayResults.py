...
# displayCumulative_at_once(df_before['Number of Vehicles Stopped'], df_after['Number of Vehicles Stopped'], 'Number of Vehicles Stopped')
# displayCumulative_at_once(df_before['Total Waiting Time of All Vehicles'], df_after['Total Waiting Time of All Vehicles'], 'Total Waiting Time of All Vehicles' )
# displayCumulative_at_once(df_before['Total CO2 Emissions Released'], df_after['Total CO2 Emissions Released'], 'Total CO2 Emissions Released')
